...
class SignalCorrector:
	import numpy as np
	def __init__(self,df,MinThres=np.pi/4.):	
		 ...
		 for i in range(1,10):
			 ...
			 for Ii in range(Nx-1):				 
				 ...
				 if  (Iac > 0) and (Inx < 0):
					 ...
					 cx1.plot(self.df['Frame Index'].values[Ia:In],self.df[Sx].values[Ia:In],'.r')						
			 ...
			 for Ij in range(Ny-1):				 
				...
				if  (Iac > 0) and (Iny < 0):
					 ...
					 cx2.plot(self.df['Frame Index'].values[Ia:In],self.df[Sy].values[Ia:In],'.r')
			 ...
			 for Ik in range(Nz-1):		 
				 ...
				 if  (Iac > 0) and (Inz < 0):
					 ...
					 cx3.plot(self.df['Frame Index'].values[Ia:In],self.df[Sz].values[Ia:In],'.r')
...
def Tpose_Ref(Eu_ref,Op):
	...
	if Op == 'Init_Ref':
		...
		Eu.append([-0.00, -1.75, -1.75])	
		Eu.append([-0.00,  0.00, -3.00])	
		Eu.append([-0.00,  0.00, -3.00])	
		Eu.append([-0.00,  3.00, -3.00]) 
		Eu.append([-0.00,  1.75,  0.00])	
		Eu.append([-0.00,  1.75, -0.00])
		Eu.append([-0.00,  1.75,  2.20])
		Eu.append([-0.00,  1.75, -2.80])
		Eu.append([-0.00,  1.75,  0.00])
